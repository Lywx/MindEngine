namespace MindEngine.Graphics
{
    ...
    public interface IMMRendererStringOperations
    {
        ...
        void DrawMonospacedString(MMFont font, string str, Point position, Color color, float scale, MMHorizontalAlignment halignment = MMHorizontalAlignment.Right, MMVerticalAlignment valignment = MMVerticalAlignment.Bottom, int leading = 0);
        ...
        void DrawString(MMFont font, string str, Point position, Color color, float scale, MMHorizontalAlignment halignment = MMHorizontalAlignment.Right, MMVerticalAlignment valignment = MMVerticalAlignment.Bottom, int leading = 0);
    }
    ...
    public interface IMMGraphicsRenderer : IMMDrawableComponent,
